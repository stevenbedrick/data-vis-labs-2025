...
Make sure to keep in mind the design principles that we discussed on Tuesday regarding spacing, use of rules, row-vs-column orientation, alignment, etc. In addition to the table itself, provide a short description of your design and its motivation.

# Fonts

1. Spend some time on [Google Fonts](https://fonts.google.com) (or a different font repository) and pick out a serif, sanserif, and display font that "speaks to you". 
