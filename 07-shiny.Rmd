...
For this week, you will construct and deploy a Shiny app that will let the user explore Kieran Healy's [`covdata` package](https://kjhealy.github.io/covdata/) containing up-to-date covid19 data. There are a variety of interesting data sets in this package; feel free to draw inspiration from some of his blog posts (under "Articles" on the `covdata` home page). I strongly recommend referring to the [Shiny links on the syllabus](https://cslu.ohsu.edu/~bedricks/courses/bmi525/syllabus/7-seventh.html) for additional information and ideas!