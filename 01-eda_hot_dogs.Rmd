...
nathan_ann <- nathan_plot +
  ...
  annotate('segment', x=2006.75, xend=2022.25, y= 79, yend=79, size=0.5, color="#E9602B") +
  annotate('segment', x=2006.75, xend=2006.75, y= 79, yend=77, size=0.5, color="#E9602B") +
  annotate('segment', x=2022.25, xend=2022.25, y= 79, yend=77, size=0.5, color="#E9602B") +
  annotate('segment', x=2015, xend=2015, y= 82, yend=79, size=0.5, color="#E9602B") +
