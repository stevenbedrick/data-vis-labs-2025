...
The finished data set is available at [here](https://stevenbedrick.github.io/data-vis-labs-2023/data/artworks.csv), and is also present locally in the RStudio Cloud project:
...
<div class="panel panel-success">
  ...
  <div class="panel-body">
We'll do this together *(nothing to turn in)*: see [slides](https://stevenbedrick.github.io/data-vis-labs-2023/slides/02-slides.html#16).
  </div>
</div>
...
- Go back to [Lab 01](https://stevenbedrick.github.io/data-vis-labs-2023/01-eda_hot_dogs.html) to review how to do the following:
