...
The data set is available at [http://bit.ly/cs631-moma](http://bit.ly/cs631-moma), and is also present locally in the RStudio Cloud project:
...
<div class="panel panel-success">
  ...
  <div class="panel-body">
We'll do this together *(nothing to turn in)*: see [slides](https://stevenbedrick.github.io/data-vis-labs-2021/slides/02-slides.html#16).
  </div>
</div>
...
- Go back to [Lab 01](https://stevenbedrick.github.io/data-vis-labs-2021/01-eda_hot_dogs.html) to review how to do the following:
